...
import {Seach} from "@/components/Icons";
...
const Header = (props: {
    ...
    return (
        <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
            <div className="flex flex-grow items-center justify-between px-4 py-2 shadow-2 md:px-6 2xl:px-9">
                    ...
                    <form action="https://formbold.com/s/unique_form_id" method="POST">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent pl-9 pr-4 font-medium focus:outline-none xl:w-125 text-xs"
                            />
                        </div>
                    </form>
                </div>
