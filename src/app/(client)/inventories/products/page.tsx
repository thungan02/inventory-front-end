...
import TableInventoryProduct, {TableInventoryProductHandle} from "@/components/Tables/TableInventoryProduct";
...
import {TableProviderHandle} from "@/components/Tables/TableProvider";

const InventoryProductPage = () => {
    const tableInventoryProductRef = useRef<TableInventoryProductHandle>();
    const [showExportModal, setShowExportModal] = useState<boolean>(false);
    const [exportType, setExportType] = useState<string>('FILTERED');
    const handleExport = () => {
        if (tableInventoryProductRef.current) {
            tableInventoryProductRef.current?.exportInventoryProducts(exportType);
    ...
    return (
        <DefaultLayout>
            ...
            <TableInventoryProduct ref={tableInventoryProductRef}/>
        </DefaultLayout>
    );
};
